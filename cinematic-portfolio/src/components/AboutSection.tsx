...
import rikasPortrait from '../assets/rikas-portrait.jpg';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Riyal Rikas Mohammed</span>, a dedicated Software Engineer and computing student pursuing my Higher National Diploma (HND) in Software Engineering at BCAS Campus Jaffna. With practical exposure in Java, Python, JavaScript, PHP, and MySQL, I specialize in building reliable full-stack applications, clean user interfaces, and structured backend systems rooted in strong Object-Oriented principles.
            </motion.p>
          ...
          <div className="lg:col-span-5 flex items-center justify-center relative perspective-[1400px]">
            ...
            >
              ...
              <div className="relative overflow-hidden w-full max-w-[390px] aspect-[4/5] bg-black rounded-sm">
                ...
                <img
                  src={rikasPortrait}
                  alt="Riyal Rikas Mohammed"
                  className="w-full h-full object-cover object-top filter brightness-[0.98] contrast-[1.05] saturate-[1.02] group-hover:brightness-105 group-hover:contrast-[1.12] transition-all duration-700 ease-out"
                />
