...
import heroVideo from '../assets/Man_walking_forward_20260919203534.mp4';
          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                SOFTWARE ENGINEER <span className="text-[#8C6D4F] mx-1">•</span> FULL STACK DEVELOPER <span className="text-[#8C6D4F] mx-1">•</span> AI ENTHUSIAST
              </p>
            </motion.div>
            ...
            >
              <p>
                I turn ideas into reliable software and seamless digital experiences.
                <br />
                Where clean frontend meets structured backend architectures, engineering code that drives real value.
              </p>
            </motion.div>
            ...
            >
              ...
              <motion.a
                href="/Riyal_Rikas_Mohammed_Resume.pdf"
                download="Riyal_Rikas_Mohammed_Resume.pdf"
                target="_blank"
